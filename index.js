fetch('./data.json')
  .then(res => res.json())
  .then(data => {
    console.log("Shuffled deck from backend:", data);
  });

const cardObjectDefinitions = [
    {id:1, imagePath:'images/10diam.jpg'},
    {id:2, imagePath:'images/jacksclubcard.jpg'},
    {id:3, imagePath:'images/queendiamond.jpg'},
    {id:4, imagePath:'images/aceofspades2.jpg'}
]
const aceId = 4

const cardBackImgPath = 'images/backofcard2.jpg'
...
function gameOver()
{
    ...
    // Update the button
    playGameButtonElem.textContent = "Home page";
